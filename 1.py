...
def mainpage():
        ...
        def word_cloud_1():
            try:
                ...
                wc1data_func = wordcloud.WordCloud(font_path='C:\\Windows\\Fonts\\msyh.ttc',
                                                   ...
                                                   height=2800,
                                                   mode='RGB',
                                                   background_color='white', mask=imread(wc1png_path)).fit_words(
                    wc1data_dic)
        ...
        def word_cloud_2():
            try:
                ...
                wc2data_func = wordcloud.WordCloud(font_path='C:\\Windows\\Fonts\\msyh.ttc',
                                                   ...
                                                   mask=imageio.imread(wc2png_path)).fit_words(wc2data_dic)
    ...
    def Lantent_Dirichlet_Allocation():
        ...
        def model_lda():
            try:
                ...
                stop_words = list(
                    pd.read_csv(LDAstopwords_path, names=['word'], sep='aaa', encoding='UTF-8', engine='python').word)
    ...
    menu_probabilistic_graphical_model.add_command(label='Lantent Dirichlet Allocation',
                                                   command=Lantent_Dirichlet_Allocation)
